...
$mod_strings                                    = array(
	'LBL_DELETE_USER_CONFIRM'                      => 'レコードを削除すると、紐づくユーザのレコードも削除されます。<br/><br/>ユーザレコードを削除するには、OKをクリックしてください。',
	'LBL_DELETE_GROUP_CONFIRM'                     => 'グループユーザを削除しますか？ ユーザレコードを削除するには、OKをクリックしてください。',
	'LBL_DELETE_PORTAL_CONFIRM'                    => 'ポータルAPIユーザを削除しますか? ユーザレコードを削除するには、OKをクリックしてください。',
	'LNK_IMPORT_USERS'                             => 'ユーザをインポート',
	'ERR_DELETE_RECORD'                            => '取引先を削除するにはレコード番号を指定する必要があります。',
	'ERR_EMAIL_INCORRECT'                          => 'パスワードの送信用に有効なEメールアドレスを指定してください。',
	...
	'ERR_IE_FAILURE2'                              => 'Eメールアカウントでの接続に問題がありました。設定を確認して再度試行してください。',
	'ERR_IE_MISSING_REQUIRED'                      => 'インバウンドメール設定の必要な情報が足りません。
設定を確認して再実行してください。
...
インバウンド電子メールを設定していない場合は、このセクションのすべてのフィールドをクリアして下さい。',
	...
	'ERR_PASSWORD_USERNAME_MISSMATCH'              => '有効なユーザ名とEメールを入力してください。',
	'ERR_PASSWORD_LINK_EXPIRED'                    => 'リンクが切れました。再度作成してください。',
	...
	'ERR_RULES_NOT_MET'                            => '入力されたパスワードに誤りがあります。再度パスワードを入力してください。',
	'ERR_USER_INFO_NOT_FOUND'                      => 'ユーザ情報が見つかりません。',
	'ERR_USER_NAME_EXISTS_1'                       => 'ユーザ名,',
	'ERR_USER_NAME_EXISTS_2'                       => 'は既に存在します。ユーザ名の重複はできません。<br>',
	'ERR_USER_IS_LOCKED_OUT'                       => 'ログイン禁止ユーザ。このユーザはロックされています。',
	'LBL_PASSWORD_SENT'                            => '更新されたパスワード',
	'LBL_CANNOT_SEND_PASSWORD'                     => 'パスワード送信不可',
	'ERR_EMAIL_NOT_SENT_ADMIN'                     => 'システムはリクエストを受けることができませんでした。:',
	'ERR_SMTP_URL_SMTP_PORT'                       => 'SMTPサーバURLとポート',
	'ERR_SMTP_USERNAME_SMTP_PASSWORD'              => 'SMTPユーザ名とSMTPパスワード',
	'ERR_RECIPIENT_EMAIL'                          => '受信Eメール',
	'ERR_SERVER_STATUS'                            => 'サーバステータス',
	'ERR_SERVER_SMTP_EMPTY'                        => 'システムはユーザにメールを送信することができませんでした。送信メール設定をご確認ください。 <a href=\"index.php?module=EmailMan&action=config\">Eメール設定s</a>.',
	...
	'LBL_RECAPTCHA_UNKNOWN'                        => 'キャプチャ認証失敗',
	...
	'LBL_RESET_HOMEPAGE_WARNING'                   => 'ホームページをリセットしても良いですか？',
	...
	'LBL_MAIL_SMTP_SETTINGS'                       => 'SMTPサーバ証明書',
	'LBL_CHOOSE_EMAIL_PROVIDER'                    => 'Eメールプロバイダーの選択:',
